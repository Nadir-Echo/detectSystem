        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="图片1">
              <el-image :src1="detailForm.image1" fit="contain" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="图片2">
              <el-image :src2="detailForm.image2" fit="contain" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
  ...
  methods: {
    ...
    handleDetail(row) {
      ...
      getImg(row.pid).then(response => {
        this.detailForm.image1 = response.data.image1
        this.detailForm.image2 = response.data.image2
      })
