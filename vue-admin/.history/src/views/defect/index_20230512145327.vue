...
export default {
  data() {
    return {
      ori_url: 'https://echo-img-1305917469.cos.ap-nanjing.myqcloud.com/defect/1683867076_orignal.jpg',
      result_url: ''
    }
  },
  methods: {
    handleResponse(event) {
      ...
      fetch('http://localhost:8010/defectimg', {
        ...
        .then((jsonResponse) => {
          // 从JSON对象中获取需要的数据
          const ori_url = jsonResponse.ori_url
          const result_url = jsonResponse.result_url
