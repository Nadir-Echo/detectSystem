...
```bash
python train.py --img 224 --batch 16 --epochs 3 --data coco128.yaml --weights yolov5s.pt --cache
```

or with custom project and task name:

```bash
python train.py --project my_project --name my_training --img 224 --batch 16 --epochs 3 --data coco128.yaml --weights yolov5s.pt --cache
```
...
```bash
python train.py --img 224 --batch 16 --epochs 3 --data clearml://<your_dataset_id> --weights yolov5s.pt --cache
```
